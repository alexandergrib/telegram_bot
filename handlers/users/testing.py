...
#  https://www.youtube.com/watch?v=O_pPNlXMzsw&list=PLwVBSkoL97Q3phZRyInbM4lShvS1cBl-U&index=11
...
# @dp.message_handler(Command("client"), state=None)
...
#         }
#     )
#     await message.answer(f"Вы ввели, {new_client}")
#     await state.finish()
    # Вариант завершения 2
    # await state.reset_state()
